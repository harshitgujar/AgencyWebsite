    ...
    >
      ...
      >
        <div className="w-full h-full flex flex-col justify-start gap-6 px-8 py-6">
          {/* Bio text */}
          <p
            className="font-['DiamondGrotesk',sans-serif] text-[13px] text-white leading-[1.7] not-italic"
            style={{
              opacity: isOpen ? 1 : 0,
          ...
          >
            {member.instagram && (
              <a
                ...
                className="flex items-center gap-2 text-white text-[12px] font-['DiamondGrotesk',sans-serif] uppercase tracking-wider hover:text-white/60 transition-colors duration-300"
              >
